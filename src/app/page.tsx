  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col overflow-x-hidden glow-mesh selection:bg-primary/30">
      ...
      <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-full max-w-5xl px-4">
        <header className="h-14 glass-morphism premium-border rounded-full flex items-center justify-between px-6 md:px-8 bg-background/40 backdrop-blur-3xl transition-all duration-500 neo-shadow border border-white/10 ring-1 ring-primary/20">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/chat">
              <Button variant="default" className="rounded-full px-5 font-bold text-[9px] h-8 premium-border bg-primary shadow-primary/30 hover:shadow-primary/50 transition-all duration-700 uppercase tracking-widest">
                JOIN
              </Button>
            </Link>
          </div>
      ...
      <main className="flex-1">
        <section className="relative pt-24 pb-12 px-6 text-center max-w-7xl mx-auto overflow-visible min-h-screen flex flex-col justify-center">
          ...
          <div className="space-y-4 relative">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter leading-[1.1] text-gradient">
              {t.heroTitle1} <br/>
              <span className="text-primary">{t.heroTitle2}</span>
            </h1>
            <p className="text-sm md:text-base text-muted-foreground max-w-xl mx-auto leading-relaxed font-light tracking-wide">
              {t.heroDesc}
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 pt-8">
            <Link href="/chat">
              <Button size="lg" className="h-12 px-8 rounded-2xl text-sm font-bold shadow-primary/20 group hover:scale-105 transition-all duration-700 relative overflow-hidden bg-white text-black hover:bg-primary hover:text-white border-none neo-shadow">
            ...
            <Link href="/builder">
              <Button variant="outline" size="lg" className="h-12 px-8 rounded-2xl text-sm font-bold glass-morphism premium-border hover:bg-white/5 transition-all duration-700 hover:scale-105">
                {t.ctaSecondary}
              </Button>
            </Link>
          </div>

          <div className="pt-12 flex flex-wrap justify-center gap-6 md:gap-12 opacity-20 grayscale hover:grayscale-0 transition-all duration-1000">
            <div className="flex items-center gap-2 font-bold tracking-[0.3em] text-[7px]"><Orbit className="w-4 h-4" /> QUANTUM</div>
            <div className="flex items-center gap-2 font-bold tracking-[0.3em] text-[7px]"><Shield className="w-4 h-4" /> ETHEREUM</div>
            <div className="flex items-center gap-2 font-bold tracking-[0.3em] text-[7px]"><Zap className="w-4 h-4" /> SOLANA</div>
            <div className="flex items-center gap-2 font-bold tracking-[0.3em] text-[7px]"><Hexagon className="w-4 h-4" /> POLYGON</div>
          </div>
        </section>

        <section id="architecture" className="py-16 px-6 relative bg-gradient-to-b from-transparent via-primary/5 to-transparent">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12 space-y-4 text-center">
              <h2 className="text-3xl md:text-4xl font-black tracking-tighter text-gradient">{t.archTitle}</h2>
              <p className="text-muted-foreground text-sm max-w-lg mx-auto font-light tracking-wide">{t.archDesc}</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              <ProductCard 
                className="md:col-span-8 h-[340px]"
                icon={MessageSquare}
                title={t.p2pTitle}
                desc={t.p2pDesc}
                link="/chat"
              ...
              />
              <ProductCard 
                className="md:col-span-4 h-[340px]"
                icon={Layers}
              ...
              />
              <ProductCard 
                className="md:col-span-5 h-[300px]"
                icon={Lock}
              ...
              <div className="md:col-span-7 glass-morphism premium-border rounded-[2rem] p-8 flex flex-col justify-center gap-4 group hover:border-primary/40 transition-all duration-700 bento-inner-glow">
                <div className="flex items-center justify-between">
                  <div className="w-12 h-12 bg-white/5 premium-border rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:bg-primary/10 transition-all duration-700">
                    <Terminal className="w-6 h-6 text-white group-hover:text-primary transition-colors" />
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <p className="text-[7px] font-bold uppercase tracking-widest opacity-40 mb-1">Network Integrity</p>
                      <p className="text-primary font-black text-lg">99.999%</p>
                    </div>
                    <div className="w-8 h-8 glass premium-border rounded-full flex items-center justify-center shadow-inner">
                      <div className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                    </div>
                  </div>
                </div>
                <div className="space-y-1">
                  <h4 className="text-xl font-black tracking-tight">Hyper-Latency Protocol</h4>
                  <p className="text-muted-foreground text-sm leading-relaxed font-light">Global decentralized infrastructure with sub-ms synchronization and neural DDoS mitigation.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="py-16 border-t border-white/5 px-8 bg-[#010101]/95 backdrop-blur-3xl">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-2 space-y-4">
            <h5 className="text-[8px] font-bold uppercase tracking-[0.3em] opacity-30">Resources</h5>
            <ul className="space-y-2 text-[9px] font-medium">
          ...
          <div className="md:col-span-2 space-y-4">
            <h5 className="text-[8px] font-bold uppercase tracking-[0.3em] opacity-30">Network</h5>
            <ul className="space-y-2 text-[9px] font-medium">
          ...
          <div className="md:col-span-3 space-y-4">
            <h5 className="text-[8px] font-bold uppercase tracking-[0.3em] opacity-30">Relay Node</h5>
            <div className="p-4 glass-morphism premium-border rounded-xl space-y-2 bento-inner-glow">
              <div className="flex items-center gap-2 text-[8px] font-bold text-primary">
                <div className="w-1 h-1 rounded-full bg-primary animate-pulse" />
                SYSTEM STATUS: OPTIMAL
              </div>
              <p className="text-[7px] opacity-40 uppercase tracking-[0.2em] leading-loose">
                Web3CyberServices <br/>
        ...
        <div className="max-w-7xl mx-auto pt-12 text-center opacity-20 text-[7px] font-bold tracking-[0.4em] uppercase">
...
function ProductCard({ icon: Icon, title, desc, link, color, bgColor, cta, className }: any) {
  return (
    <Link href={link} className={`group p-6 glass-morphism premium-border rounded-[2rem] hover:border-primary/50 transition-all duration-1000 hover:shadow-[0_40px_100px_rgba(34,197,94,0.15)] flex flex-col gap-4 bento-inner-glow ${className}`}>
      <div className={`w-10 h-10 ${bgColor} premium-border rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-1000`}>
        <Icon className={`w-5 h-5 ${color}`} />
      </div>
      <div className="space-y-2">
        <h3 className="text-xl md:text-2xl font-black tracking-tighter text-gradient">{title}</h3>
        <p className="text-muted-foreground text-xs md:text-sm leading-relaxed font-light">{desc}</p>
      </div>
      <div className="mt-auto flex items-center text-[8px] font-bold gap-2 text-primary opacity-0 group-hover:opacity-100 transition-all duration-1000 translate-y-2 group-hover:translate-y-0 tracking-[0.2em] uppercase">
...
function SocialIcon({ icon: Icon }: any) {
  return (
    <div className="w-8 h-8 glass premium-border rounded-lg flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all cursor-pointer group hover:scale-110 duration-500">
