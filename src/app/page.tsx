  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col overflow-x-hidden glow-mesh selection:bg-primary/30">
      ...
      <main className="flex-1">
        <section className="relative pt-32 pb-16 px-6 text-center max-w-7xl mx-auto overflow-visible min-h-[90vh] flex flex-col justify-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-12">
            <Link href="/chat">
              <Button size="lg" className="h-14 px-10 rounded-[2rem] text-sm font-bold shadow-primary/20 group hover:scale-105 transition-all duration-700 relative overflow-hidden bg-white text-black hover:bg-primary hover:text-white border-none neo-shadow">
            ...
            <Link href="/builder">
              <Button variant="outline" size="lg" className="h-14 px-10 rounded-[2rem] text-sm font-bold glass-morphism premium-border hover:bg-white/5 transition-all duration-700 hover:scale-105">
                {t.ctaSecondary}
              </Button>
            </Link>
          </div>
        ...
        <section id="architecture" className="py-24 px-6 relative bg-gradient-to-b from-transparent via-primary/5 to-transparent">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
              ...
              />
              <ProductCard 
                className="md:col-span-5 h-[360px]"
                icon={Shield}
              ...
              <div className="md:col-span-7 glass-morphism premium-border rounded-[4.5rem] p-12 flex flex-col justify-center gap-6 group hover:border-primary/40 transition-all duration-700 bento-inner-glow">
                <div className="flex items-center justify-between">
                  <div className="w-16 h-16 bg-white/5 premium-border rounded-[2rem] flex items-center justify-center group-hover:scale-110 group-hover:bg-primary/10 transition-all duration-700">
      ...
      <footer className="py-24 border-t border-white/5 px-8 bg-[#010101]/95 backdrop-blur-3xl">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16">
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <div className="p-6 glass-morphism premium-border rounded-[2rem] space-y-3 bento-inner-glow">
        ...
        <div className="max-w-7xl mx-auto pt-16 text-center opacity-20 text-[9px] font-bold tracking-[0.4em] uppercase">
...
function ProductCard({ icon: Icon, title, desc, link, color, bgColor, cta, className }: any) {
  return (
    <Link href={link} className={`group p-8 glass-morphism premium-border rounded-[4.5rem] hover:border-primary/50 transition-all duration-1000 hover:shadow-[0_40px_100px_rgba(34,197,94,0.15)] flex flex-col gap-6 bento-inner-glow ${className}`}>
...
function SocialIcon({ icon: Icon }: any) {
  return (
    <div className="w-10 h-10 glass premium-border rounded-[1.25rem] flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/10 transition-all cursor-pointer group hover:scale-110 duration-500">
